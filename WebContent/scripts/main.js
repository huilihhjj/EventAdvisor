(function() {
  ...
  function onSessionValid(result) { 
	...
	msg.innerHTML = 'Welcome, ' + user_fullname;
	showElement(msg);
  ...
  function loadRegisterPage(){
	  console.warn("loading resgister page");
	  var loginForm = document.getElementById("login­form");
		 var registerForm = document.getElementById("registerform");
		 var itemNav = document.getElementById("item-nav");
		 var itemList = document.getElementById("item-list");
...
//Login
  ...
  function logout(){
	  ...
	  ajax('GET', url, req,
			  function(res) {
	  		  ...
	  		  function(){
	  			  console.warn("Logout not successful");
	  		  });
  }
  ...
  function onLoadPositionFailed() {
    console.warn('Getting geolocation by navigator failed.');
    getLocationFromIP();
  }
  ...
  function getLocationFromIP() {
    ...
    ajax('GET', url, req, function(res) {
      ...
      if ('loc' in result) {
        ...
        console.warn('Getting geolocation by IP failed.');
      }
      loadNearbyItems();
    });
  }
